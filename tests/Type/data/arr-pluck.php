...
function test(
    ...
    assertType('list<string>', Arr::pluck($list, 'user.name'));
    assertType('array<string, string>', Arr::pluck($list, 'user.name', 'user.name'));
    assertType('list<string>', Arr::pluck($list, ['user', 'name']));
    assertType('array<string, string>', Arr::pluck($list, ['user', 'name'], ['user', 'name']));
    assertType('list<string>', Arr::pluck($list, function ($l) {
