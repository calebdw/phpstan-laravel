...
{
    private const string USER_TITLE      = 'Application bootstrap failed';
    private const string FRAMEWORK_TITLE = 'Laravel framework bootstrap failed';
    ...
    private function formatFrameworkError(Throwable $throwable, bool $includeErrorDetails = true, bool $decorated = true): string
    {
        $parts = [
            ...
            '',
            'This extension launches your Laravel application during analysis to provide smarter results.',
